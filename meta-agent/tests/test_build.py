"""meta-agent practical layer: assemble_agent (builder) + CLI parser. Without GPU (FakeBackend)."""
from meta_agent import FakeBackend, Tool, ToolRegistry, assemble_agent
from meta_agent.cli import build_parser
