...
wrapper [meta-spider] breaks it (hidden Pass 1, latent decision). 95% here is standard
...
decision → action). Independent of the training toolkit.
    ...
    from meta_agent import MetaAgent, ToolRegistry, Tool, FakePolicy
...
from .backends import (
    ...
    LlamaCppBackend, MetaSpiderBackend, OpenAIBackend,
)
from .native import (
...
from .policy import BackendPolicy, FakePolicy, MetaSpiderPolicy, Policy
...
__all__ = [
    ...
    "Policy", "FakePolicy", "BackendPolicy", "MetaSpiderPolicy",
