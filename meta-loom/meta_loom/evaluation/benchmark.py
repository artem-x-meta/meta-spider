...
from meta_loom.evaluation.harness import compute_metrics, classify_action
...
class AgenticBenchmark(Benchmark):
    """DEPRECATED (not in the public API) — use `meta_loom.evaluation.AgentComparison`.
    ...
    native tool format. `AgentComparison` delegates to Meta-Agent (the real runtime + `NativeToolPrompt`
