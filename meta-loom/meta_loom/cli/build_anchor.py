...
Mirrors `build-universal` (the Doubter factory) but for the behavior modifier:
...
def build_anchor_stage(
    ...
    from meta_daimon import GoalAnchor, GoalAnchorConfig
    from meta_loom.data import code_spec_sessions as cs
    from meta_loom.data.drift_sessions import collect_goal_activations
    ...
    manifest = {"model_name": model_name, "quantization": quantization,
                "target_layers": target_layers, "cross_attn_layers": cross_attn_layers,
                "modifier": "goal_anchor", "families": fams, "mine_specs": mine_specs,
