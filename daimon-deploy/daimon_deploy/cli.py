...
encoder spec against PyTorch — that spec is what the library ggml/C++ (cpp/) translates. Console-script: `metadeploy`.
"""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    pv.add_argument("--framework-path", default=None,
                    help="fallback path to daimon-framework-dev when meta_attention is not installed")
