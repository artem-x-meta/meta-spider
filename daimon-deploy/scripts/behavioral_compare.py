...
Usage:
  python behavioral_compare.py --n 40 --offset 6000 \
    ...
    --framework-path daimon-framework-dev --loader-path publish/github
"""
...
def main():
    ...
    ap.add_argument("--framework-path", default=None, help="(vestigial — daimon_loom is installed editable)")
    ap.add_argument("--loader-path", default=None, help="(vestigial — the native loader lives in daimon_loom.data)")
    ...
    from daimon_loom.data.dataset import check_answer_correctness, load_qa_dataset
    from daimon_loom.evaluation.harness import classify_action
    ...
    cfg = MetaAttentionConfig(model_name="google/gemma-2-2b-it", device=args.device, dtype="float16",
