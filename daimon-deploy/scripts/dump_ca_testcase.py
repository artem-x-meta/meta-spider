"""M3a/4a helper: dump a test case for the ggml BottleneckCrossAttention (the meta-attention library: cpp/meta_ca.cpp).
...
from daimon_deploy import export_sidecar
